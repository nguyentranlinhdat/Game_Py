...
ITEM_BOX_SIZE = 80
UI_FONT = '../Chevalier/graphics/font/joystix.ttf'
UI_FONT_SIZE = 18
...
magic_data = {
	'flame': {'strength': 5,'cost': 20,'graphic':'../Chevalier/graphics/particles/flame/fire.png'},
	'heal' : {'strength': 20,'cost': 10,'graphic':'../Chevalier/graphics/particles/heal/heal.png'}}
#enemy
...
monster_data = {
	...
	'raccoon': {'health': 300,'exp':250,'damage':40,'attack_type': 'claw',  'attack_sound':'../Chevalier/audio/attack/claw.wav','speed': 2, 'resistance': 3, 'attack_radius': 120, 'notice_radius': 400},
	'spirit': {'health': 100,'exp':110,'damage':8,'attack_type': 'thunder', 'attack_sound':'../Chevalier/audio/attack/fireball.wav', 'speed': 4, 'resistance': 3, 'attack_radius': 60, 'notice_radius': 350},
	'bamboo': {'health': 70,'exp':120,'damage':6,'attack_type': 'leaf_attack', 'attack_sound':'../Chevalier/audio/attack/slash.wav', 'speed': 3, 'resistance': 3, 'attack_radius': 50, 'notice_radius': 300}}
